...
function actions.RenderSettingsRewardsCustomSection()
    ...
    ImGui.TextColored(0.54, 0.63, 0.68, 1.00,'E.g. 3h|12h|6h|36h|24h or 6h|12h')
    ...
    ImGui.TextColored(0.54, 0.63, 0.68, 1.00,'E.g. 3|2|1|4|5')
    ImGui.SetCursorPosX(5)
    ImGui.PushItemWidth(100)
    ...
    ImGui.TextColored(0.54, 0.63, 0.68, 1.00,'E.g. Uncommon|Rare|Easy|Elite')
    ImGui.SetCursorPosX(5)
    ...
    ImGui.TextColored(0.54, 0.63, 0.68, 1.00,'E.g. Exploration|Diplomacy|Trade|Plunder')
    ...
    ImGui.TextColored(0.54, 0.63, 0.68, 1.00,'E.g. Rarities|Types|Levels|Durations')
    ImGui.SetCursorPosX(5)
    ImGui.PushItemWidth(200)
